...
const EventsPage = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50 overflow-hidden font-sans text-slate-800">
      {/* --- Navbar --- */}
      <nav className="bg-white border-b border-gray-200 px-6 flex items-center gap-8 shadow-sm z-20 shrink-0">
                    ...
                    {selectedEvent.payload?.purposes?.length > 0 && (
                      <div>
                        ...
                        <div className="grid grid-cols-1 gap-4">
                          {selectedEvent.payload.purposes.map(
                            (purpose, idx) => (
                              <div
                                key={idx}
