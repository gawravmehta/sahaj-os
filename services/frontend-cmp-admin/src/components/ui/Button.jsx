...
const Button = ({
  ...
  const baseStyles = " rounded-full transition duration-300 cursor-pointer ";
  ...
  const variantStyles = {
    ...
    icon: "flex items-center justify-center text-[#babdc9] hover:text-secondarytext",
    ghost:
    ...
    back: "text-[#737373] text-primary rounded-none cursor-pointer  text-sm  h-8 px-3 flex items-center  gap-1 justify-center px-2",
  };
  ...
  return (
    ...
    >
      ...
      <span
        className={
          btnLoading ? "invisible" : "visible flex items-center gap-1 "
        }
      >
        {children}
      </span>
