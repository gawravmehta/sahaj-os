...
# from app.api.v1.deps import get_current_user, get_dpar_service # Placeholder, need to check actual deps

client = TestClient(app)
BASE_URL = "/api/v1/dpar" # Placeholder, need to check actual base URL
...
#     # app.dependency_overrides[get_dpar_service] = lambda: mock_service # Placeholder
#     yield
